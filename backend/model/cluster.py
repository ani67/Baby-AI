...
class Cluster:
    ...
    age: int = 0
    dormant: bool = False
    lens: torch.Tensor = field(default_factory=lambda: torch.zeros(512))  # per-cluster input correction
    ...
    def forward(
        ...
        """
        # Per-cluster lens: correct input for what this cluster sees
    ...
    def update_lens(self, error: torch.Tensor, activation: float, lr: float):
        """Nudge lens toward reducing this cluster's share of the error."""
